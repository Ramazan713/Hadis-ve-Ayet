...
/// @nodoc
abstract class $PrayerCustomCopyWith<$Res> {
  factory $PrayerCustomCopyWith(
          PrayerCustom value, $Res Function(PrayerCustom) then) =
      _$PrayerCustomCopyWithImpl<$Res, PrayerCustom>;
  @useResult
  $Res call(
      {int? id,
      String name,
...
/// @nodoc
class _$PrayerCustomCopyWithImpl<$Res, $Val extends PrayerCustom>
    implements $PrayerCustomCopyWith<$Res> {
  _$PrayerCustomCopyWithImpl(this._value, this._then);
...
class _$_PrayerCustom with DiagnosticableTreeMixin implements _PrayerCustom {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'PrayerCustom'))
