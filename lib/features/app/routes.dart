...
final kRouters={
  ...
  ShowCounterPage.id: (context) => ShowCounterPage(),
  ManageCounterPage.id: (context)=> const ManageCounterPage(),
  CounterDetailPage.id: (context) => const CounterDetailPage(),
  CounterDetailSettingPage.id: (context)=> const CounterDetailSettingPage(),
  AddCounterPage.id: (context)=>AddCounterPage(),
  EsmaulHusnaPage.id: (context)=> const EsmaulHusnaPage(),
  DetailEsmaulHusnaPage.id: (context)=> DetailEsmaulHusnaPage(),
