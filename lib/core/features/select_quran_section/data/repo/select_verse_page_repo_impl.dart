...
class SelectQuranPageRepoImpl extends SelectQuranPageRepo{

  late final SelectVersePageDao _selectVersePageDao;

  SelectQuranPageRepoImpl({
  ...
  @override
  Future<String?> validateLastVerseNumber(String validatedFirstVerseNumber, String lastVerseNumber, int surahId) async{
    final isValid = (await _selectVersePageDao.existsLastVerseNumber(validatedFirstVerseNumber, lastVerseNumber, surahId));

    if(isValid ?? false) return lastVerseNumber;
    return validatedFirstVerseNumber;
  }
