...
abstract class SearchDao{
  ...
  //All Hadiths
  //By using Regex
  @Query("""select count(id) from hadiths where lower(content) REGEXP lower(:regExp)""")
  ...
  //By using Like
  @Query("""select count(id) from hadiths where lower(content) Like lower(:query)""")
  Future<int?> getCountAllHadithByLike(String query);

  @Query("""
    select * from hadiths where lower(content) Like lower(:query)
    limit :pageSize offset :startIndex
  """)
  ...
  //Hadith Books
  //By using Regex
  @Query("""select count(id) from hadiths where bookId=:bookId and lower(content) REGEXP lower(:regExp)""")
  Future<int?> getCountHadithByRegexAndBookId(int bookId, String regExp);

  @Query("""
    select * from hadiths where bookId=:bookId and lower(content) REGEXP lower(:regExp) 
    limit :pageSize offset :startIndex
  """)
  ...
  //By using Like
  @Query("""select count(id) from hadiths where bookId=:bookId and lower(content) Like lower(:query)""")
  Future<int?> getCountHadithByLikeAndBookId(int bookId, String query);

  @Query("""
    select * from hadiths where bookId=:bookId and lower(content) Like lower(:query) 
    limit :pageSize offset :startIndex
  """)
  ...
  //Verses
  //By using Regex
  @Query("""select count(id) data from verses V where lower(content)  REGEXP lower(:regExp) """)
  Future<int?> getCountVerseByRegex(String regExp);

  @Query("""
    select * from verses where lower(content)  REGEXP lower(:regExp)
    limit :pageSize offset :startIndex
  """)
  ...
  //By using Like
  @Query("""select count(id) data from verses V where lower(content) Like lower(:query) """)
  Future<int?> getCountVerseByLike(String query);

  @Query("""
    select * from verses where lower(content)  Like lower(:query)
    limit :pageSize offset :startIndex
  """)
