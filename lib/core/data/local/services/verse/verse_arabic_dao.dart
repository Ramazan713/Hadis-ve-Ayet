...
abstract class VerseArabicDao{
  ...
  @Query("""
    ...
    (select A.mealId from verses V, verseAudios A where V.id=A.mealId and V.id=:mealId and A.identifier = :identifier)
    order by mealId
  """)
  ...
  @Query("""
    ...
    (select A.mealId from verses V, verseAudios A where V.id=A.mealId and V.id in (:mealIds) and A.identifier = :identifier)
    order by mealId
  """)
  ...
  @Query("""
    ...
    (select A.mealId from verses V, verseAudios A where V.id=A.mealId and V.surahId=:surahId and A.identifier = :identifier)
    order by mealId
  """)
  ...
  @Query("""
    ...
    (select A.mealId from verses V, verseAudios A where V.id=A.mealId and V.cuzNo=:cuzNo and A.identifier = :identifier)
    order by mealId
  """)
  ...
  @Query("""
    ...
    (select A.mealId from verses V, verseAudios A where V.id=A.mealId and V.pageNo=:pageNo and A.identifier = :identifier)
    order by mealId
  """)
