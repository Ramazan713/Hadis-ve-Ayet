...
abstract class HadithDaoOld{
  ...
  @Query("select * from hadith limit :limit offset :limit * ((:page) -1)")
  ...
  @Query("""select * from hadith where bookId=:bookId  limit :limit offset :limit * ((:page) -1)""")
  ...
  @Query("""select H.* from Hadith H,HadithTopic HT
  ...
  @Query("""select * from Hadith where bookId=:bookId and
  ...
  @Query("""select * from Hadith where lower(content) Like lower(:query)
      limit :limit offset :limit * ((:page) -1)""")
